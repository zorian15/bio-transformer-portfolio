...
| text-only-free-cleaned | prose alone, database bookkeeping removed | 384 | 0.755 ± 0.003 | 0.669 ± 0.005 | 0.649 ± 0.007 |
| text-only-free-ablated | prose alone, compartment sentences removed | 384 | 0.682 ± 0.001 | 0.505 ± 0.012 | 0.493 ± 0.009 |
| text-only-free-random-ablated | prose alone, as much text removed at random | 384 | 0.700 ± 0.005 | 0.546 ± 0.003 | 0.527 ± 0.003 |
| sequence+free-text-cleaned | isolates the evidence-code confound | 864 | 0.850 ± 0.001 | 0.751 ± 0.002 | 0.723 ± 0.002 |
| sequence+free-text-ablated | the ablation: grounding or leakage | 864 | 0.816 ± 0.001 | 0.664 ± 0.009 | 0.643 ± 0.009 |
| sequence+free-text-random-ablated | length-matched control for the ablation | 864 | 0.822 ± 0.002 | 0.668 ± 0.004 | 0.649 ± 0.005 |
